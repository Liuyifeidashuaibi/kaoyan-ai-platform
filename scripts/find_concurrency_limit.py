...
# 设计智能请求控制方案
def design_request_control(max_concurrent):
    print("\n📝 智能请求控制方案设计:")
    print("----------------------------------------")
...
if __name__ == "__main__":
    max_concurrent = find_concurrency_limit()
    design_request_control(max_concurrent)